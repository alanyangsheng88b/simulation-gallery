...
一个极简卡片画廊风格的静态网站，展示 18 个电子/物理仿真小程序。每个仿真运行在独立沙箱 iframe 中。
...
| EDA 级天线射频仿真 | S参数分析、阻抗匹配、驻波比与辐射效率 |
| 天线偶极子 EDA 仿真 | EDA风格偶极子天线设计与电流分布可视化 |
| EDA 电磁偶极辐射场仿真 | 近场与远场辐射仿真，场强分布与极化分析 |
| 偶极子电场线全可视化 | 电场线从电荷分离到稳态的完整生成过程 |
| 相控阵波束赋形 | 阵元相位控制、波束扫描与方向图合成 |
| 矢量磁位 & 偶极子辐射场 | 基于磁矢势推导辐射场，可视化场关系 |
